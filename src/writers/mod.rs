//! A trait for additional log writers, and a configurable concrete implementation
//! for a log writer writing to a file or a series of files.
//!
//! Additional log writers can be used to direct certain log messages to other log
//! ouput streams than the default log file, as for example an alert file or the syslog.
//!
//! See also [`Logger.add_writer()`](../struct.Logger.html#method.add_writer).
//!
